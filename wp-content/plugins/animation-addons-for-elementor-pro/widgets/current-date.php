...
class Current_Date extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Current Date', 'wcf-addons-pro' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Current Date', 'wcf-addons-pro' ),
		...
		$this->add_control(
			'date_format',
			[
				'label'   => esc_html__( 'Date Format', 'wcf-addons-pro' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'F j, Y',
				'options' => [
					'F j, Y' => esc_html__( 'F j, Y', 'wcf-addons-pro' ),
					'Y-m-d'  => esc_html__( 'Y-m-d', 'wcf-addons-pro' ),
					'm/d/Y'  => esc_html__( 'm/d/Y', 'wcf-addons-pro' ),
					'd/m/Y'  => esc_html__( 'd/m/Y', 'wcf-addons-pro' ),
		...
		$this->add_control(
			'custom_date_format',
			[
				'label'       => esc_html__( 'Custom Format', 'wcf-addons-pro' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'F j, Y', 'wcf-addons-pro' ),
				'placeholder' => esc_html__( 'F j, Y', 'wcf-addons-pro' ),
		...
		$this->add_control(
			'day_options_heading',
			[
				'label'     => esc_html__( 'Day', 'wcf-addons-pro' ),
		...
		$this->add_control(
			'day_text_color',
			[
				'label'     => esc_html__( 'Day Color', 'wcf-addons-pro' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
        ...
        <div <?php $this->print_render_attribute_string( 'wrapper' ); ?>>
			<?php if ( ! empty( $settings['show_day'] ) ) : ?>
				...
				if ( ! empty( $settings['day_separator'] ) ) {
					?><span class="separator"><?php echo esc_html__( $settings['day_separator'] ); ?></span><?php
				}
				?>
			<?php endif; ?>
