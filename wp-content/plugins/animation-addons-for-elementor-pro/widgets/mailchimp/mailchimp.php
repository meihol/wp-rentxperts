...
class Mailchimp extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Mailchimp', 'wcf-addons-pro' );
	}
	...
	protected function register_mailchimp_controls() {
		...
		$this->add_control(
			'mailchimp_api',
			[
				'label'       => __( 'MailChimp API', 'wcf-addons-pro' ),
				'type'        => Controls_Manager::TEXT,
				'label_block' => true,
				'placeholder' => __( 'Enter your mailchimp api here', 'wcf-addons-pro' ),
				'dynamic'     => [ 'active' => true ],				
		...
		$this->add_control(
			'mailchimp_lists',
			[
				'label'       => __( 'Audience', 'wcf-addons-pro' ),
				'label_block' => true,
				'type'        => Controls_Manager::SELECT2,
				'multiple'    => false,
				'placeholder' => 'Choose your created audience ',				
				'options'     => [],
				'description' => esc_html__( 'Create a audience/ list in mailchimp account ', 'wcf-addons-pro' ) . '<a href="https://mailchimp.com/help/create-audience/" target="_blank"> ' . esc_html__( 'Create Audience', 'wcf-addons-pro' ) . '</a>',
			]
		);
		...
		$this->add_control(
			'mailchimp_list_tags',
			[
				'label'       => __( 'Tags', 'wcf-addons-pro' ),
				'type'        => Controls_Manager::TEXT,
				'label_block' => true,
				'placeholder' => __( 'Tag-1, Tag-2', 'wcf-addons-pro' ),
				'description' => __( 'Enter tag here to separate your subscribers. Use comma separator to use multiple tags. Example: Tag-1, Tag-2, Tag-3', 'wcf-addons-pro' ),
				'condition'   => [
					'mailchimp_lists!' => '',
				],
				'dynamic'     => [ 'active' => true ],
		...
		$this->add_control(
			...
			[
				'label'        => __( 'Enable Double Opt In?', 'wcf-addons-pro' ),
	...
	protected function register_form_content_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Form', 'wcf-addons-pro' ),
				'tab'   => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			'enable_name',
			[
				'label'        => esc_html__( 'Enable Name?', 'wcf-addons-pro' ),
				'type'         => Controls_Manager::SWITCHER,
		...
		$this->add_control(
			'_fname_heading',
			[
				'label'     => esc_html__( 'First Name:', 'wcf-addons-pro' ),
		...
		$this->add_control(
			...
			[
				...
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'First Name', 'wcf-addons-pro' ),
				'placeholder' => esc_html__( 'First Name', 'wcf-addons-pro' ),
				'condition'   => [
					'enable_name'     => 'yes',
				],
				'dynamic'     => [ 'active' => true ],
		...
		$this->add_control(
			'fname_placeholder',
			[
				'label'       => esc_html__( 'Placeholder', 'wcf-addons-pro' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'First Name', 'wcf-addons-pro' ),
				'placeholder' => esc_html__( 'First Name', 'wcf-addons-pro' ),
				'condition'   => [
		...
		$this->add_control(
			...
			[
				...
				'default'   => 'before',
				'options'   => [
					'before' => esc_html__( 'Before', 'wcf-addons-pro' ),
					'after'  => esc_html__( 'After', 'wcf-addons-pro' ),
				],
				'condition' => [ 'enable_name' => 'yes' ],
			]
		);
		...
		$this->add_control(
			'_lname_heading',
			[
				'label'     => esc_html__( 'Last Name:', 'wcf-addons-pro' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
				'condition' => [
					'enable_name'     => 'yes',
		...
		$this->add_control(
			...
			[
				'label'       => esc_html__( 'Label', 'wcf-addons-pro' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Last Name', 'wcf-addons-pro' ),
				'placeholder' => esc_html__( 'Last Name', 'wcf-addons-pro' ),
				'condition'   => [
					'enable_name'     => 'yes',
				],
				'dynamic'     => [ 'active' => true ],
		...
		$this->add_control(
			'enable_phone',
			[
				'label'        => esc_html__( 'Enable Phone?', 'wcf-addons-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'separator'    => 'before',
				'label_on'     => esc_html__( 'Yes', 'wcf-addons-pro' ),
				'label_off'    => esc_html__( 'No', 'wcf-addons-pro' ),
		...
		$this->add_control(
			'_phone_heading',
			[
				'label'     => esc_html__( 'Phone:', 'wcf-addons-pro' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
				'condition' => [
					'enable_phone' => 'yes',
		...
		$this->add_control(
			...
			[
				'label'       => esc_html__( 'Label', 'wcf-addons-pro' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Phone', 'wcf-addons-pro' ),
				'placeholder' => esc_html__( 'Phone', 'wcf-addons-pro' ),
				'condition'   => [
					'enable_phone' => 'yes',
				],
				'dynamic'     => [ 'active' => true ],
		...
		$this->add_control(
			...
			[
				...
				'default'   => 'before',
				'options'   => [
					'before' => __( 'Before', 'wcf-addons-pro' ),
					'after'  => __( 'After', 'wcf-addons-pro' ),
				],
				'condition' => [ 'enable_phone' => 'yes' ],
			]
		);
		...
		$this->add_control(
			'_email_heading',
			[
				'label'     => esc_html__( 'Email:', 'wcf-addons-pro' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'Email', 'wcf-addons-pro' ),
				'dynamic'     => [ 'active' => true ],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Email', 'wcf-addons-pro' ),
				'placeholder' => esc_html__( 'Email input placeholder', 'wcf-addons-pro' ),
				'dynamic'     => [ 'active' => true ],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'    => Controls_Manager::TEXT,
				'default' => esc_html__( 'Subscribe', 'wcf-addons-pro' ),
				'dynamic' => [ 'active' => true ],
			]
		);
	...
	protected function register_label_style_controls() {
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__( 'Typography', 'wcf-addons-pro' ),
	...
	protected function register_input_style_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Input', 'wcf-addons-pro' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__( 'Box Shadow', 'wcf-addons-pro' ),
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Placeholder Color', 'wcf-addons-pro' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#000000',
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Font Size', 'wcf-addons-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
	...
	protected function register_input_icon_style_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Input Icon', 'wcf-addons-pro' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
	...
	protected function render_submit_button( $settings ) {
        ...
        <button <?php $this->print_render_attribute_string( 'button_wrapper' ); ?>
                aria-label="<?php echo esc_html__( 'Mailchimp Button', 'wcf-addons-pro' ); ?>">
			<?php
