<?php
namespace ArolaxEssentialApp\PageSettings;
...
class Page_Settings {
	...
	public function add_panel_tab() {
		//Controls_Manager::add_tab( self::PANEL_TAB, __( 'New Tab', 'arolax-essential' ) );
	}
	...
	public function register_document_controls( $document ) {
		...
		$document->add_control(
			'text',
			[
				'label' => __( 'Title', 'arolax-essential' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Title', 'arolax-essential' ),
			]
		);
