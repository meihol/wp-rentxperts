 ...
 * @since 1.0.0
 */
class Arolax_Tabs extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Arolax Tabs', 'arolax-essential' );
	}
	...
	public function get_style_depends() {
		wp_register_style( 'arolax-tabs', AROLAX_ESSENTIAL_ASSETS_URL . 'css/arolax-tabs.css' );
		return [ 'arolax-tabs' ];
	}

    // Script Dependency
	public function get_script_depends() {
		wp_register_script( 'arolax-tabs', AROLAX_ESSENTIAL_ASSETS_URL . '/js/widgets/arolax-tabs.js', [ 'jquery' ], false, true );
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_tabs',
			[
				'label' => esc_html__( 'Tabs', 'arolax-essential' ),
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'default'     => esc_html__( 'Tab Title', 'arolax-essential' ),
				'placeholder' => esc_html__( 'Tab Title', 'arolax-essential' ),
				'label_block' => true,
				'dynamic'     => [
					'active' => true,
				],
		...
		$repeater->add_control(
			...
			[
				...
				'rows' => 3,
				'default' => esc_html__( 'Add the best talent on the market, an agile skilled management & seamlessinvolvement', 'arolax-essential' ),
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'default'     => esc_html__( 'Tab Content', 'arolax-essential' ),
				'placeholder' => esc_html__( 'Tab Content', 'arolax-essential' ),
		...
		$this->add_control(
			'tabs',
			[
				'label'       => esc_html__( 'Tabs Items', 'arolax-essential' ),
				'type'        => Controls_Manager::REPEATER,
				'fields'      => $repeater->get_controls(),
				'default'     => [
					[
						'tab_title'   => esc_html__( 'Tab Title 1', 'arolax-essential' ),
						'tab_content' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'arolax-essential' ),
					],
					[
						'tab_title'   => esc_html__( 'Tab Title 2', 'arolax-essential' ),
						'tab_content' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'arolax-essential' ),
					],
					[
						'tab_title'   => esc_html__( 'Tab Title 3', 'arolax-essential' ),
						'tab_content' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'arolax-essential' ),
					],
				],
		...
		$this->add_control( 'tabs_direction',
			[
				...
				'options'      => [
					'column'         => [
						'title' => esc_html__( 'Above', 'arolax-essential' ),
						'icon'  => 'eicon-v-align-top',
					],
					'column-reverse' => [
						'title' => esc_html__( 'Below', 'arolax-essential' ),
						'icon'  => 'eicon-v-align-bottom',
					],
					'row-reverse'    => [
						'title' => esc_html__( 'After', 'arolax-essential' ),
						'icon'  => 'eicon-h-align-' . $end,
					],
					'row'            => [
						'title' => esc_html__( 'Before', 'arolax-essential' ),
		...
		$this->add_control(
			...
			[
				...
				'type'         => Controls_Manager::SELECT,
				'options'      => [
					''        => esc_html__( 'Start', 'arolax-essential' ),
					'center'  => esc_html__( 'Center', 'arolax-essential' ),
					'end'     => esc_html__( 'End', 'arolax-essential' ),
		...
		$this->start_controls_section( 'section_tabs_setting', [
			'label' => esc_html__( 'Settings', 'arolax-essential' ),
		] );

		$this->add_responsive_control(
			'tab_tittle_align',
			[
				'label'     => esc_html__( 'Title Alignment', 'arolax-essential' ),
				'type'      => Controls_Manager::CHOOSE,
				'options'   => [
					'start'  => [
		...
		foreach ( Plugin::$instance->breakpoints->get_active_breakpoints() as $breakpoint_key => $breakpoint_instance ) {
			...
			/* translators: 1: Breakpoint label, 2: `>` character, 3: Breakpoint value. */
				esc_html__( '%1$s (%2$s %3$dpx)', 'arolax-essential' ),
		...
		$this->add_control(
			'breakpoint_selector',
			[
				'label'        => esc_html__( 'Breakpoint', 'arolax-essential' ),
				'type'         => Controls_Manager::SELECT,
				'description'  => esc_html__( 'Note: Choose at which breakpoint tabs will automatically switch to a vertical (“accordion”) layout.', 'arolax-essential' ),
		...
		$this->add_control(
			'navigation_width',
			[
				'label'     => esc_html__( 'Navigation Width', 'arolax-essential' ),
				'type'      => Controls_Manager::SLIDER,
				'default'   => [
					'unit' => '%',
				],
		...
		$this->add_responsive_control( 'tabs_title_space_between',
			[
				'label'      => esc_html__( 'Gap between tabs', 'arolax-essential' ),
				'type'       => Controls_Manager::SLIDER,
				'range'      => [
					'px' => [
						'min' => 0,
		...
		$this->add_responsive_control( 'tabs_title_spacing',
			[
				'label'      => esc_html__( 'Distance from content', 'arolax-essential' ),
				'type'       => Controls_Manager::SLIDER,
				'range'      => [
					'px' => [
						'min' => 0,
		...
		$this->start_controls_section(
			'sec_style_active', [
				'label' => esc_html__( 'Hover/Active', 'arolax-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
	...
	protected function render() {
		...
		$this->add_render_attribute( 'wrapper', 'class', 'wcf--tabs arolax--tabs' );
		?>
