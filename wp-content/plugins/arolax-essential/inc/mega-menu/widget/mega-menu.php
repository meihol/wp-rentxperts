...
class WCf_Header_Mega_Menu extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Disable Megamenu in Mobile', 'arolax-essential' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Yes', 'arolax-essential' ),
				'label_off' => esc_html__( 'No', 'arolax-essential' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'offcanvas_align',
			[
				'label'   => esc_html__('Animated Direction', 'arolax-essential'),
				'type'    => Controls_Manager::CHOOSE,
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Mega Menu', 'arolax-essential' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Container layout', 'arolax-essential' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => '',
				'options' => [
					...
					'position: fixed;
						width: 100%;					  
						left: 0;' => esc_html__( 'Full Width', 'arolax-essential' ),
