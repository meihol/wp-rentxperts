...
Class Arolax_Additional_Icon{
    ...
    public function theme_custom_icon_manager($settings){
        ...
        $json_data = AROLAX_ESSENTIAL_URL . 'assets/js/elementor-icon.js';

        $settings['arolax-icon-set'] = [
           'name'          => 'wcf-icon-set',
           'label'         => esc_html__( 'Arolax Icons', 'arolax-essential' ),
           'url'           => AROLAX_CSS . '/custom-icons.css',
           'enqueue'       => [ AROLAX_CSS . '/custom-icons.css' ],
           'prefix'        => 'arolax-',
           'displayPrefix' => 'arolax-theme',
