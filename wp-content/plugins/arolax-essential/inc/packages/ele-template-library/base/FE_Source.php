...
class FE_Source extends Source_Base {
	...
	public function get_title() {
		return 'Crowdytheme Theme Template';
	}
	 ...
	 *
	 * Retrieve remote templates from https://crowdytheme.com/ servers.
	 *
	 * @since 1.14.5
	 * @access public
	 *
	...
	public function get_items( $args = [] ) {
		...
		$status = apply_filters( 'wcf/template/service/status', 200 );
		...
		return apply_filters('wcf_global_templates_library',$templates);
	}

	/**
	 * Get remote template.
	 *
	 * Retrieve a single remote template from http://wealcoder.com/ servers.
	 *
	 * @since 1.14.5
	 * @access public
	 *
	 ...
	 *
	 * Remote template from http://wealcoder.com/ servers cannot be saved on the
	 ...
	 * Remote template from http://wealcoder.com/ servers cannot be updated on the
	 * database as they are retrieved from remote servers.
	 *
	 * @since 1.14.5
	 * @access public
	 ...
	 *
	 * Remote template from http://wealcoder.com/ servers cannot be deleted from the
	 * database as they are retrieved from remote servers.
	 *
	 * @since 1.14.5
	 * @access public
	 ...
	 *
	 * Remote template from http://wealcoder.com/ servers cannot be exported from the
	 * database as they are retrieved from remote servers.
	 *
	 * @since 1.14.5
	 * @access public
	 ...
	 * Retrieve the data of a single remote template from http://wealcoder.com/ servers.	 
	 * @since 1.14.5
	 * @access public
	 *
	...
	public function template_is_pro($data = true){
	   ...
	   $result = $data == 'yes' ? true : false;
	   return apply_filters( 'wcf_pro_template_status', $result );
	}
}