...
<div class="wcf-error-tpl-wrapper">
    <h4><a class="wcf-post-layout-import-modal button button-primary csf--button" data-id="error_layout" href="javascript:void(0)"><?php echo esc_html__('Import From Library','arolax-essential') ?></a> </h4>
